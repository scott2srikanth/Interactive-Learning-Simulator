    ...
    <div style={{ fontFamily: S.sans, background: "linear-gradient(145deg, #020617 0%, #0a1628 50%, #020617 100%)", minHeight: "100vh", color: "#e2e8f0" }}>
      ...
      <div style={{ position: "sticky", top: 0, zIndex: 40, backdropFilter: "blur(16px)", background: "rgba(2,6,23,0.88)", borderBottom: "1px solid #1e293b" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "8px 20px", display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <h1 style={{ fontSize: 15, fontWeight: 800, color: "#fff", margin: 0 }}>RNN / LSTM Lab</h1>
          <span style={{ fontSize: 10, color: "#475569" }}>Interactive Recurrent Network Simulator</span>
        </div>
      </div>
